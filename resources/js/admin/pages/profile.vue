                        ...
                        <div class="p-3">
                            <div class="mb-3">
                                <div class="form-group">
                                    ...
                                    <input id="current-password" type="password" name="current-password" class="form-control" required autocomplete="new-current-password">
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form-group">
                    ...
                    <div class="rounded-3 p-3 bg-white shadow">
                        ...
                        <div class="p-3">
                            <small class="text-secondary text-opacity-75">
                                ...
                                <div class="mb-3">
                                    <div class="mb-1 text-dark fw-semibold">
                            ...
                            <div class="d-block d-sm-flex justify-content-start align-items-center flex-wrap mt-2">
                                <router-link :to="{name: 'pricing'}" class="me-2 btn btn-theme d-flex justify-content-center align-items-center px-4 mb-2">
                                    UPGRADE PLAN
                                </router-link>
                                <button type="button" class="me-2 btn btn-danger mb-2 px-4">
                                    CANCEL SUBSCRIPTION
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="rounded-3 shadow p-3 bg-white">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td class="default-width">Company Name:</td>
                                            <td class="name">ThemeSelection</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">Billing Email:</td>
                                            <td class="name">gertrude@gmail.com</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">Tax ID:</td>
                                            <td class="name">TAX-875623</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">VAT Number:</td>
                                            <td class="name">SDF754K77</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">Billing Address:</td>
                                            <td class="name">100 Water Plant Avenue, Building 1303 Wake Island</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">Contact</td>
                                            <td class="name">+1(609) 933-44-22</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">Country:</td>
                                            <td class="name">USA</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">State:</td>
                                            <td class="name">kingland</td>
                                        </tr>
                                        <tr>
                                            <td class="default-width">Zip Code:</td>
                                            <td class="name">403114</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
