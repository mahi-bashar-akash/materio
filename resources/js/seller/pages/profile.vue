    ...
    <div class="row justify-content-center">
            ...
            <div class="p-3 bg-white shadow rounded-4">
                <div class="p-3 d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div class="wpx-150 hpx-150 position-relative" v-if="url">
                        ...
                        <div class="position-absolute bottom-0 end-0 translate-middle-y cursor-pointer bg-light shadow-sm wpx-35 hpx-35 d-flex justify-content-center align-items-center rounded-circle" @click="url = null">
        ...
        <div class="col-lg-6 p-3 font-14">
            ...
            <form class="p-4 bg-white shadow rounded-4" v-if="tab === 1">
                <div class="fs-5 fw-semibold mb-3">Edit Profile</div>
                <div class="row">
            ...
            <form class="p-4 bg-white shadow rounded-4" v-if="tab === 2">
                <div class="fs-5 fw-semibold mb-3">Edit Password</div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="password-confirm" class="form-label">Contact</label>
                        <div class="position-relative">
